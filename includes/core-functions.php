...
function fs_social_share_icons(){
    $post_id = get_the_ID();
    $shareURL = urlencode(get_permalink($post_id));
    ...
    <div class="social-share-box">
	    <a class="social-share-box-link social-share-email" href="mailto:?subject=<?php echo $mailSubject; ?>&amp;body=<?php echo $mailBody; ?>"><span class="fa-stack fa-sm icon-envelope"><i class="fa fa-square fa-stack-2x"></i><i class="fa fa-envelope fa-stack-1x" title="Share on Gmail"></i>
	    </span></a>

	    <a class="social-share-box-link social-share-facebook" href="<?php echo $facebookURL; ?>" target="_blank">
	    <span class="fa-stack fa-sm icon-facebook"><i class="fa fa-square fa-stack-2x"></i><i class="fa fa-facebook fa-stack-1x" title="Share on facebook"></i>
	    </span></a>

	    <a class="social-share-box-link social-share-twitter" href="<?php echo $twitterURL; ?>" target="_blank">
	    <span class="fa-stack fa-sm icon-twitter"><i class="fa fa-square fa-stack-2x"></i><i class="fa fa-twitter fa-stack-1x" title="Share on Twitter"></i></span></a>

	    <a class="social-share-box-link social-share-google-plus" href="<?php echo $googleURL; ?>" target="_blank">
	    <span class="fa-stack fa-sm icon-gplus"><i class="fa fa-square fa-stack-2x"></i><i class="fa fa-google-plus fa-stack-1x" title="Share on google plus"></i></span></a>

	    <a class="social-share-box-link social-share-linkedin" href="<?php echo $linkedInURL; ?>" target="_blank">
	    <span class="fa-stack fa-sm icon-linkedin"><i class="fa fa-square fa-stack-2x"></i><i class="fa fa-linkedin fa-stack-1x" title="Share on LinkedIn"></i></span></a>

	    <a class="social-share-box-link social-share-whatsapp" href="<?php echo $whatsappURL; ?>" target="_blank">
	    <span class="fa-stack fa-sm icon-whatsapp"><i class="fa fa-square fa-stack-2x"></i><i class="fa fa-whatsapp fa-stack-1x" title="Share on Whatsapp"></i></span></a>

	    <a class="social-share-box-link social-share-pinterest" href="<?php echo $pinterestURL; ?>" target="_blank">
	    <span class="fa-stack fa-sm icon-pinterest"><i class="fa fa-square fa-stack-2x"></i><i class="fa fa-pinterest fa-stack-1x" title="Share on pinterest"></i>
	    </span></a>
