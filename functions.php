...
function fs_enqueue_stuff() {
    ...
    if(FS_THEME_USE_LIGHTBOX_LIB){
    	wp_enqueue_script('fs-lightbox', get_stylesheet_directory_uri() . '/assets/js/jquery.lightbox_me.min.js' , array('jquery'), FS_THEME_VERSION, true);
    }
